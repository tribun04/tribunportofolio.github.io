...
import { FaGithub, FaLinkedin, FaTwitter, FaHeart, FaArrowUp, FaCode, FaCoffee } from 'react-icons/fa';
import { SiGmail, SiReact, SiTailwindcss, SiVite } from 'react-icons/si';
...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Floating animation for back to top button
      gsap.to(".back-to-top", {
        y: -10,
        duration: 2,
        repeat: -1,
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden opacity-20">
        <div className="absolute -left-20 top-10 w-72 h-72 bg-[#bd34fe] rounded-full mix-blend-soft-light filter blur-3xl opacity-20 animate-float"></div>
        <div className="absolute -right-20 top-28 w-72 h-72 bg-[#7c3aed] rounded-full mix-blend-soft-light filter blur-3xl opacity-20 animate-float animation-delay-2000"></div>
        <div className="absolute left-40 bottom-10 w-72 h-72 bg-[#ff6cde] rounded-full mix-blend-soft-light filter blur-3xl opacity-20 animate-float animation-delay-4000"></div>
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div className="text-center lg:text-right">
            ...
            <div 
              ref={socialRef}
              className="flex justify-center lg:justify-end gap-4 mb-6"
            >
              {socialLinks.map((link, index) => (
                <a
                  ...
                  className={`
                    group relative w-12 h-12 rounded-xl bg-gray-800/50 border border-gray-700 
                    flex items-center justify-center text-xl text-gray-400 transition-all duration-300
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div 
            ref={textRef}
            className="flex flex-col items-center md:items-start gap-2 text-gray-400"
          >
            <p className="text-sm flex items-center gap-2">
              <span>© {currentYear} Tribun Bajra. All rights reserved.</span>
            </p>
            <p className="text-xs flex items-center gap-1">
              Crafted with <FaHeart className="text-red-500 mx-1 animate-pulse" /> 
              and <FaCoffee className="text-amber-500 mx-1" />
            </p>
          </div>
